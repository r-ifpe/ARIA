...
test_that("read_rfept works", {
  ...
  qacademico <- read_rfept(system.file(
    "extdata/examples/qacademico", package = "ARIA"
  ))

  qacademico_2 <- read_rfept(
    system.file("extdata/examples/qacademico", package = "ARIA"),
    start = "2019.2"
  )
...
test_that("read_qacademico works", {
  ...
  qacademico <- read_qacademico(system.file("extdata/examples/qacademico", package = "ARIA"))
...
test_that("read_sigaa works", {
  ...
  sigaa <- read_sigaa(system.file("extdata/examples/sigaa", package = "ARIA"))
...
test_that("correct_course_name works", {
  ...
  expect_equal(
    ARIA:::correct_course_name(wrong_course_name),
