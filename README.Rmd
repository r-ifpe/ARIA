---
title: "ARIA: Tools to Analyze and Update Sistec Datasets"
output:
  github_document:
    fig_width: 9
    fig_height: 5
---
  ...
  [![Travis build status](https://travis-ci.org/r-ifpe/sistec.svg?branch=master)](https://travis-ci.org/r-ifpe/ARIA)
  [![CRAN\_Status\_Badge](https://www.r-pkg.org/badges/version/ARIA)](https://cran.r-project.org/package=ARIA)
  [![R build status](https://github.com/R-IFPE/ARIA/workflows/R-ubuntu/badge.svg)](https://github.com/R-IFPE/ARIA/actions)
  [![R build status](https://github.com/R-IFPE/ARIA/workflows/R-macOS/badge.svg)](https://github.com/R-IFPE/ARIA/actions)
  [![CircleCI build status](https://circleci.com/gh/r-ifpe/sistec.svg?style=svg)](https://circleci.com/gh/r-ifpe/ARIA)
